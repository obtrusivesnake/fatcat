<?php
// sections/classes/class-list.php - Product grid of all group classes

$classes = [
    // ── Sunday ──
    [
        "day" => "Sunday",
        "name" => "Ballroom After Noon",
        "instructor" => "Terry Schmoyer",
        "time" => "2:00 PM &ndash; 4:00 PM",
        "price" => 0,
        "price_label" => "Free",
        "level" => "All Levels",
        "description" =>
    ...
    [
        "day" => "Sunday",
        "name" => "Arizona Two-Step",
        "instructor" => "Keith",
        "time" => "5:00 PM &ndash; 6:00 PM",
        "price" => 10,
        "price_label" => '$10',
        "level" => "All Levels",
        "description" =>
    ...
    [
        "day" => "Monday",
        "name" => "American Ballroom &ndash; Beginning Smooth",
        "instructor" => "Chad, Marie &amp; Vladi",
        "time" => "6:00 PM",
        "price" => 10,
        "price_label" => '$10',
        "level" => "Beginner",
    ...
    [
        "day" => "Monday",
        "name" => "American Ballroom &ndash; Intermediate Smooth",
        "instructor" => "Chad, Marie &amp; Vladi",
        "time" => "6:45 PM",
        "price" => 10,
        "price_label" => '$10',
    ...
    [
        "day" => "Monday",
        "name" => "American Ballroom &ndash; Guided Practice",
        "instructor" => "Chad, Marie &amp; Vladi",
        "time" => "7:30 PM",
        "price" => 5,
        "price_label" => '$5',
        "level" => "All Levels",
        "description" =>
            "Put your new skills to work with guided practice time. Get feedback from instructors while you dance in a social setting.",
        "note" => "Currently featuring Waltz",
    ],
    ...
    [
        "day" => "Wednesday",
        "name" => "International Ballroom &ndash; Beginning",
    ...
    [
        "day" => "Wednesday",
        "name" => "International Ballroom &ndash; Intermediate",
        "instructor" => "Roseann &amp; Bob",
        "time" => "7:15 PM",
        "price" => 10,
        "price_label" => '$10',
    ...
    [
        ...
        "level" => "All Levels",
        "description" =>
            "Practice what you&rsquo;ve learned with instructor guidance in a relaxed dance party atmosphere.",
        "note" => "Currently featuring Waltz",
    ],
                ...
                <article class="bg-stone-950 p-6 sm:p-8 flex flex-col">
                    ...
                    <p class="text-sm text-stone-500 mb-4">
                        <?php if ($class["instructor"]): ?>
                            <?php echo $class["instructor"]; ?> &middot;
                        <?php endif; ?>
                    ...
                    <div class="flex items-end justify-between gap-4 mt-auto pt-5">
                        ...
                        <?php else: ?>
                            ...
                            <a href="#book"
                               class="inline-flex items-center bg-[#c9a96e] hover:bg-[#d4b87d] text-stone-950 font-semibold text-sm px-5 py-2.5 rounded transition-colors tracking-wide">
                                Reserve
                                <svg class="w-3.5 h-3.5 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
