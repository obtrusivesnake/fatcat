<?php
/**
 * Icon helper — a Lucide-style SVG icon library
 *
 * Usage:
 *   <?= icon('calendar') ?>                     — 24×24, stroke-width 1.5
 *   <?= icon('sparkles', 'w-12 h-12 text-[#c9a96e] mb-5') ?>  — custom classes
 *
 * All paths are sourced from Lucide (https://lucide.dev).
 * To add a new icon, just drop another key into the $paths array.
 */
...
if (!function_exists('icon')) {
    function icon(string $name, string $class = 'w-6 h-6'): string
    {
        static $paths = [
            ...
            'headphones'    => '<path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H4a1 1 0 0 1-1-1zM21 14h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2a1 1 0 0 0 1-1zM3 18v-6a9 9 0 0 1 18 0v6"/>',
        ...
        return '<svg class="' . $class . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">' . $inner . '</svg>';
    }
}
